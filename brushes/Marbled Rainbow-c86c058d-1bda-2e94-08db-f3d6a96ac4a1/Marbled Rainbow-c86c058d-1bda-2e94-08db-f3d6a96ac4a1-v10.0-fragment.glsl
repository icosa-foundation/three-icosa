...
void main() {
    ...
    vec3 indirectSpec = IndirectSpecularApprox(bumpNormal, eyeDir, specularColor, smoothness, u_ambient_light_color.rgb);
    vec3 color = lightOut0 + lightOut1 + ambientOut + indirectSpec;
