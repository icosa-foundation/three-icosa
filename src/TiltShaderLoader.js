...
const tiltBrushMaterialParams = {
    ...
    "WetPaint" : {
        uniforms: {
            ...
            u_EmissionColor: { value: new Vector4(0, 0, 0, 1) },
            ...
            u_SpecColor: { value: new Vector3(0.139706, 0.139706, 0.139706) },
    ...
    "MylarTube" : {
      // TODO Uniforms: MylarTube
        uniforms: {
            ...
            u_fogDensity: { value: 0 },
            u_ClipEnd: { value: -1.0 },
            u_ClipStart: { value: 0.0 },
            u_Color: { value: new Vector4(0, 0, 0, 1) },
            u_Cutoff: { value: 0.5 },
            ...
            u_TimeBlend: { value: 0.0 },
            u_TimeOverrideValue: { value: new Vector4(0, 0, 0, 0) },
            u_TimeSpeed: { value: 1.0 },
    ...
    "LeakyPen" : {
      // TODO Uniforms: LeakyPen
        uniforms: {
            ...
            u_fogDensity: { value: 0 },
            u_BumpScale: { value: 1.0 },
            u_Color: { value: new Vector4(0.441176, 0.441176, 0.441176, 1) },
            u_Cutoff: { value: 0.5 },
            u_DetailNormalMapScale: { value: 1.0 },
            u_DstBlend: { value: 0.0 },
            u_EmissionColor: { value: new Vector4(0, 0, 0, 1) },
            ...
            u_Glossiness: { value: 0.5 },
            u_GlossyReflections: { value: 1.0 },
            u_LineColor: { value: new Vector4(0.151581, 0.62766, 0.941176, 1) },
    ...
    "Rising Bubbles" : {
      // TODO Uniforms and name fix: RisingTODO Uniforms: Bubbles
        uniforms: {
            ...
            u_OverrideTime: { value: 0.0 },
            u_Parallax: { value: 0.02 },
            u_ScrollDistance: { value: new Vector4(0.5, 5, 0, 0.5) },
            ...
            u_SpecColor: { value: new Vector3(0.5, 0.5, 0.5) },
            u_SpecularHighlights: { value: 1.0 },
    ...
    "TaperedWire" : {
      // TODO Uniforms: TaperedWire
        uniforms: {
            ...
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.0955882, 0.0955882, 0.0955882) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
    ...
    "ThickGeometry" : {
      // TODO Uniforms: ThickGeometry
        uniforms: {
            ...
            u_BumpScale: { value: 1.0 },
            u_Color: { value: new Vector4(0.705882, 0.705882, 0.705882, 1) },
            u_Cutoff: { value: 0.2 },
            u_DetailNormalMapScale: { value: 1.0 },
            u_DstBlend: { value: 0.0 },
            u_EmissionColor: { value: new Vector4(0, 0, 0, 1) },
            ...
            u_Shininess: { value: 0.414 },
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.537255, 0.537255, 0.537255) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
    ...
    "Muscle" : {
      // TODO Uniforms: Muscle
        uniforms: {
            ...
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.0808824, 0.0808824, 0.0808824) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
    ...
    "Guts" : {
      // TODO Uniforms: Guts
        uniforms: {
            ...
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.237457, 0.257941, 0.264706) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
    ...
    "Lacewing" : {
      // TODO Uniforms: Lacewing
        uniforms: {
            ...
            u_Shininess: { value: 0.8 },
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.147059, 0.147059, 0.147059) },
    ...
    "Marbled Rainbow" : {
      // TODO Uniforms and name fix: Marbled Rainbow
        uniforms: {
            ...
            u_Shininess: { value: 0.8 },
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.220588, 0.220588, 0.220588) },
    ...
    "KeijiroTube" : {
      // TODO Uniforms: KeijiroTube
        uniforms: {
            ...
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.757353, 0.757353, 0.757353) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
    ...
    "SmoothHull" : {
      // TODO Uniforms: SmoothHull
        uniforms: {
            ...
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.294118, 0.294118, 0.294118) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
    ...
    "InkGeometry" : {
      // TODO Uniforms: InkGeometry
        uniforms: {
            ...
            u_Shininess: { value: 0.4 },
            u_SmoothnessTextureChannel: { value: 0.0 },
            u_SpecColor: { value: new Vector3(0.235294, 0.235294, 0.235294) },
            u_SpecularHighlights: { value: 1.0 },
            u_SrcBlend: { value: 1.0 },
            u_UVSec: { value: 0.0 },
            u_ZWrite: { value: 1.0 }
